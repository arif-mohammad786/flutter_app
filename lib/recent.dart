...
class RecentSongs extends StatefulWidget {
  ...
  RecentSongs({this.changeTrack,this.createRecentSongsList , this.songs,this.key});
...
class _RecentSongsState extends State<RecentSongs> {
  ...
  getSongs(s) async {
    ...
    // print("${sn["subtitle"]}");
    // print("@@@@@@@@@@@");
    // print(widget.songs[sn["index"]].artist);
    // print("-------------");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Recent Songs', style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ),
